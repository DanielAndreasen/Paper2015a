...
the J, H, and K bands, which covers more than $\SI{15000}{\AA}$.
...
page\footnote{\url{http://www.univie.ac.at/crirespop/data.htm}}. We
...
consistency check. The measured EWs from the fully reduced spectra was
consistent with the measured EWs from the pipeline reduced spectra. As
mentioned above, we use the J, H, and K bands which are all available
...
metallicity of +0.19 dex).}. We make this cut since the \ion{Fe}{i} and
...
to the average literature value. The resulting atmospheric parameters
