...
\citep[see e.g.][]{Girardi2000,Dotter2008,Baraffe2015}. Although the
mass and radius can be measured directly in the case of eclipsing binaries.
...
effective temperature. In that respect, the infrared flux method (IRFM) is usually
considered as one of the most reliable methods for FGK dwarf
and subgiant stars. However, the IRFM needs a priori knowledge
of the bolometric flux, reddening, surface gravity and stellar metallicity
...
\citep[see e.g.][]{Melendez1999,Tsantaki2013,Sousa2008a,Bensby2014,Mucciarelli2013}.
...
be applied for FGKM stars in a consistent way as it is currently done
...
Using the EW method, the abundance of individual lines are
calculated by the radiative transfer code MOOG \citep{Sneden1973}
version 2013 under the assumption of local thermodynamic equilibrium (LTE).
...
iron (\ion{Fe}{i}) and single ionized iron (\ion{Fe}{ii}) as a proxy
...
the observed absorption line, otherwise we remove the line from the line
...
parameters which resemble the Sun. The spectrum for such a target
...
of 6660K and metallicity of +0.19 dex).}. We make this cut since the \ion{Fe}{i} and
...
reason for these high error bars. As the CRIRES-POP team continue their
...
E.D.M, N.C.S., and S.G.S. also acknowledge the support from FCT
through Investigador FCT contracts of reference SFRH/BPD/76606/2011,
IF/00169/2012, and IF/00028/2014, respectively, and
