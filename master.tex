...
Fig~\ref{fig:Fe1_before_recal} the EWs of the Sun of the Fe I lines
are plotted with respect to the excitation potential. This plot shows
the distribution before recalibration of the oscillator strengths
and cut for lines with abundances deviating more than 1 dex from the
...
converge with our minimization routine. These runs are not considered
in the plot. The derived atmospheric parameters are presented in
Table~\ref{tab:sun}.
...
\section{Conclusion}
This is al fantastic. Have a nice São João :)
