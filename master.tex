...
(for details see Section~\ref{sec:the_method}). To use this method the
...
Several NIR spectrographs are upcoming and some in use already. A list of
some with highest spectral resolution are listed in Table~\ref{tab:spectrograph}.
