...
of 50. At higher signal-to-noise ratios the precision increases. E.g.
at a signal-to-noise ratio at 100 the erros are reduced by a factor
...
\begin{figure*}[tbp!]
    ...
    \caption{This plot shows the abundances of all \ion{Fe}{i} lines before
